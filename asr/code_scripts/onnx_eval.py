#Assuming we have the manifest created, this script is going to be for transcribing the text using Onnx models and storing them onto a text file.
...
config_path = "/mnt/sangraha/venkat_shadeslayer/asr/momodels/model_config.yaml"
...
for i in audio_files_set:
    ...
    output_path = "/mnt/sangraha/venkat_shadeslayer/asr/outputs/Onnx_Outputs.txt"
    with open(output_path, 'a') as output_file:
        print(f"Audio File: {audio_file}, Transcription: {output}")
        output_file.write(f"Audio File: {audio_file}, Transcription: {output}\n")
