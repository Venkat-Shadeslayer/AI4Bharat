...
audio_paths = ["/mnt/sangraha/venkat_shadeslayer/asr/indictts/hindi/wavs/train_hindifullfemale_00803.wav"]
logits = asr_model.transcribe(audio_paths)[0]

# Assuming build_ctcdecoder is defined elsewhere
decoder = build_ctcdecoder(asr_model.decoder.vocabulary)
